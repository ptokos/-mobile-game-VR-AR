...
public class ObjectController : MonoBehaviour
{
    ...
    /// </summary>
    public Material InactiveMaterial;//블루

    /// <summary>
    /// The material to use when this object is active (gazed at).
    /// </summary>
    public Material GazedAtMaterial;//핑크
    ...
    {
        SetMaterial(true);
        StartCoroutine(FadeCamera(ball1)); //핑크
    }
    IEnumerator FadeCamera(Transform ball1)
    {
        Camera.main.transform.parent.position = ball1.position;
        print(Camera.main.transform.parent.name);
